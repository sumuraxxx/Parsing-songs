...
cookies = os.environ.get('COOKIES_FOR_IDS')
...
headers = {
    ...
    'x-yandex-music-client-now': '2024-02-25T17:19:30+04:00',
}
...
response = requests.get(
    'https://music.yandex.ru/api/v2.1/handlers/playlist/1623232884/3',
    params=params,
    cookies=cookies,
    headers=headers,
)
